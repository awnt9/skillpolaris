...
SYSTEM_PROMPT = (
    ...
    "A management or lead role over a technical team is still non-technical "
    "management and should be rejected unless the text itself shows the role "
    "personally does hands-on technical work (writing code, configuring or "
    "building systems), not just directing, hiring, or setting strategy for a "
    "team that does. Managing or leading builders is not the same as building.\n"
    "Accept only when the text itself describes hands-on technical work (writing code, "
    "configuring or building systems, operating infrastructure). A technical-sounding "
    "title, or generic consulting language about \"technical solutions\", \"delivery\", or "
    "\"implementation projects\" without concrete technical detail, is not enough; use "
    "uncertain instead of accept when the text does not make the technical content clear.\n"
