...
SparklesBase.displayName = "Sparkles";
...
export default function Sparkles(props: Record<string, unknown>) {
  return <SparklesBase {...(__originkitPresetProps as Record<string, unknown>)} {...props} />;
}
